...
const Player = () => {
    ...
    return (
        <>
            ...
            <iframe allowFullScreen sandbox="allow-scripts allow-same-origin" style={{ display: 'flex', alignItems: "center", justifyContent: "center", width: "100%", height: "80vh" }} src={getSmashystreamUrl(id)}></iframe>
